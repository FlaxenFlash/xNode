...
namespace XNodeEditor {
    ...
    public static class NodeEditorGUILayout {
        ...
        public static void PortField(GUIContent label, Siccity.XNode.NodePort port, params GUILayoutOption[] options) {
            ...
            if (port.direction == Siccity.XNode.NodePort.IO.Input) rect.position = rect.position - new Vector2(16, 0);
            else if (port.direction == Siccity.XNode.NodePort.IO.Output) rect.position = rect.position + new Vector2(rect.width, 0);
            rect.size = new Vector2(16, 16);
